  ...
  return (
    ...
    <div className="position-sticky top-0 w-100 " style={{zIndex:1}} >
      ...
      <div className="col-auto">
          <img src="main.png"  alt="" className='img-fluid'/>
          </div>
        <div className="col-auto">
        ...
        <div className=" text-wrap d-flex  flex-column justify-content-center align-items-center ">
          ...
          <p className='text-secondary m-2 w-75 text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae molestias quidem, deleniti quam itaque ipsum sit nisi similique officiis nemo? Unde incidunt, atque quibusdam mollitia repellat quae officia laudantium maxime.</p>
          <div className="">
