      ...
      <div className="container m-auto my-5 h-100" id="qualification">
        <h3>#Qualifications</h3>
          <div className="row row-cols-1 row-cols-md-2 d-flex justify-content-center align-items-center m-0 p-0">
            ...
            <div className="col row row-cols-1 d-flex justify-content-center">
            <button className="btn text-primary outline-light m-2">Work</button>
            <div className="col m-2 bg-dark p-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates reprehenderit totam at esse officiis ex soluta aperiam atque, repellat quos repellendus sequi, doloribus dolore deserunt. At, necessitatibus! Aspernatur, eum nesciunt.</div>
            <div className="col m-2 bg-dark p-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates reprehenderit totam at esse officiis ex soluta aperiam atque, repellat quos repellendus sequi, doloribus dolore deserunt. At, necessitatibus! Aspernatur, eum nesciunt.</div>
            <div className="col m-2 bg-dark p-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates reprehenderit totam at esse officiis ex soluta aperiam atque, repellat quos repellendus sequi, doloribus dolore deserunt. At, necessitatibus! Aspernatur, eum nesciunt.</div>
            <div className="col m-2 bg-dark p-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates reprehenderit totam at esse officiis ex soluta aperiam atque, repellat quos repellendus sequi, doloribus dolore deserunt. At, necessitatibus! Aspernatur, eum nesciunt.</div>
            </div>
